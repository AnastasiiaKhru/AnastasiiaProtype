...
function loadNCRData() {
    ...
    setTimeout(() => {
        try {
            ...
            console.error('Error loading NCR data:', error);  // Add console log for debugging
            loadingMessage.style.display = 'none';
...
function filterNCRs() {
    ...
    if (filteredRecords.length === 0) {
        tableBody.innerHTML = '<tr><td colspan="5">No NCRs found that match your criteria.</td></tr>';
    } else {
